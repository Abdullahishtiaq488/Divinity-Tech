  ...
  return (
    <header
      className={`sticky top-0 z-50 w-full transition-all duration-300 ${
        scrolled ? "backdrop-blur-md shadow-lg border-b-2" : "shadow-sm border-b"
      }`}
      style={{
        backgroundColor: scrolled ? "var(--color-background)" : "var(--color-background)",
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 py-3 md:py-4">
        ...
        >
          <AdaptiveLogo className="group-hover:scale-110 transition-transform duration-300" width={140} height={45} />
        </Link>
                        ...
                        {link.dropdown.map((item, index) => (
                          <Link
                            ...
                            style={{
                              ...
                              borderBottom:
                                index < link.dropdown!.length - 1 ? "1px solid var(--color-border)" : "none",
                            }}
                            onMouseEnter={(e) => {
                              e.currentTarget.style.backgroundColor = "var(--color-surface)"
                              e.currentTarget.style.color = "var(--color-accent)"
